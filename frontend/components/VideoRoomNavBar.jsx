...
const VideoRoomNavBar = ({roomName, handleLogout}) => {
  return (
    <div className="bg-gray-100 h-16 py-4 px-10 flex justify-between items-center text-base absolute bottom-0 w-full">
      ...
      <div className="flex items-center">
        ...
        <button className="flex items-center ml-4">
          ...
          <span className="text-sm text-gray-900">Stop Video</span>
          </button>
        </div>
        <div>
          <button className="flex items-center ml-4">
      ...
      <div className=" flex items-center ">
        <button className="bg-red-600 text-white rounded-md py-2 px-4 cursor-pointer" onClick={handleLogout}>Leave Room</button>
      </div>
    </div>
  )
}
